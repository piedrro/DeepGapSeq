...
from DeepGapSeq.DeepFretSimulate.lib import utils
from DeepGapSeq.DeepFretSimulate.lib.utils import global_function
from DeepGapSeq.DeepFretSimulate.lib.utils import min_none
...
def predict_batch(X, model, batch_size=256, progressbar = None):
    """
...
def generate_traces(
    ...
    blink_prob=0.2,
    bleed_through=(0, 0),
    aa_mismatch=(-0.05, 0.05),
    trace_length=300,
    trans_prob=(0.05, 0.10),
    noise=(0.05, 0.10),
    trans_mat=None,
    au_scaling_factor=1,
    ...
    def generate_single_trace(*args):
        ...
        for j in range(n_pairs):
            ...
            first_bleach = min_none((bleach_D, bleach_A))
        ...
        if is_aggregated:
            ...
            first_bleach_all = min_none(first_bleach_all)
