...
class _inceptiontime_methods:
    ...
    def load_inceptiontime_model(self, model_path=""):
        ...
        try:
            ...
            if os.path.exists(model_path) == False:
                model_directory = resources.files(importlib.import_module(f'DeepGapSeq.GUI.InceptionTime_models'))
    ...
    def _detect_inceptiontime_states(self, progress_callback):
        ...
        try:
            ...
            model = self.load_inceptiontime_model()
    ...
    def _detect_inceptiontime_states_cleanup(self):
        ...
        try:
            print("InceptionTime states detected")
                ...
                for dataset_name, dataset_data in self.data_dict.items():
                    for localisation_index, localisation_data in enumerate(dataset_data):
                        ...
                        if pred_label == target_label:
                            self.data_dict[dataset_name][localisation_index]["user_label"] = target_user_label
                            self.data_dict[dataset_name][localisation_index]["nucleotide_label"] = target_nucleotide_label
