...
from model import InceptionTime as InceptionTimeCustom
...
directory_path = r"\\physics\dfs\DAQ\CondensedMatterGroups\AKGroup\Jagadish\Traces for ML_GAP-sequencing"
...
if __name__ == '__main__':
    ...
    model = InceptionTimeCustom(1,len(np.unique(y))).to(device)
